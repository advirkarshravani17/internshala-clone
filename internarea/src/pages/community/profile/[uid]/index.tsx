...
console.log("PROFILE UID SENT TO API:", profileUid);
        ...
        const res = await axios.get<BackendUser>(
          `https://internshala-clone-2qo8.onrender.com/api/users/uid/${profileUid}`
        );
    ...
    const fetchUserPosts = async () => {
      try {
        const res = await axios.get<Post[]>(
          `https://internshala-clone-2qo8.onrender.com/api/posts/user/${profileUid}`
        );
        setPosts(res.data);
      } catch (err) {
  ...
  const addFriend = async () => {
    ...
    try {
      await axios.put(
        `https://internshala-clone-2qo8.onrender.com/api/users/add-friend/${reduxUser.uid}`,
  ...
  const removeFriend = async () => {
    ...
    try {
      await axios.put(
        `https://internshala-clone-2qo8.onrender.com/api/users/remove-friend/${reduxUser.uid}`,
        { friendUid: profileUid }
      );
