...
const CommunityProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserPosts = async () => {
            try {
                const res = await axios.get<Post[]>(`https://internshala-clone-2qo8.onrender.com/api/posts/user/${reduxUser.uid}`);
                setPosts(res.data);
            } catch (err) {
                console.error(err);
            }
    ...
    useEffect(() => {
        ...
        axios
            .get(`https://internshala-clone-2qo8.onrender.com/api/users/uid/${reduxUser.uid}`)
    ...
    const addNewPost = async () => {
        ...
        try {
            ...
            const res = await axios.post<Post>("https://internshala-clone-2qo8.onrender.com/api/posts", payload);
    ...
    const deletePost = async (_id: string) => {
        ...
        try {
            await axios.delete(`https://internshala-clone-2qo8.onrender.com/api/posts/${_id}`);
  ...
  try {
    const res = await axios.put(
      `https://internshala-clone-2qo8.onrender.com/api/posts/like/${_id}`,
    ...
    const handleShare = async (_id: string) => {
        await axios.put(`https://internshala-clone-2qo8.onrender.com/api/posts/share/${_id}`);
    ...
    const handleComment = async (_id: string, text: string) => {
        ...
        const res = await axios.post<{ comments: Comment[] }>(
            `https://internshala-clone-2qo8.onrender.com/api/posts/comment/${_id}`,
